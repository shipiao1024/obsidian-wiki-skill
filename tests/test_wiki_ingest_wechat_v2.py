...
""",
    ...
    def test_main_allows_empty_collection_rerun(self) -> None:
        ...
        with mock.patch.object(_wi, "parse_args", return_value=args), mock.patch.object(
    ...
    def test_article_output_exists_requires_raw_or_source_or_brief(self) -> None:
        ...
        # No files exist → False
        self.assertFalse(wiki_ingest_wechat.article_output_exists(vault, slug))
        # Raw alone → True (raw is always created, even on compile failure)
    ...
    def test_ingest_article_reports_compile_reason_when_llm_compile_falls_back(self) -> None:
        ...
        with mock.patch(
            "pipeline.compile.try_llm_compile",
        ...
        self.assertEqual(result["compile_mode"], "failed")
